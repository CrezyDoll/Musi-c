...
from SankiMusic.utilities.strings import get_command, get_string, helpers
from SankiMusic import bot
from SankiMusic.misc import SUDOERS
from SankiMusic.modules.main.database import get_lang, is_commanddelete_on
from SankiMusic.modules.main.decorators import (LanguageStart,
                                                  languageCB)
from SankiMusic.utilities.inline.help import (help_pannel, help_back_markup,
                                               private_help_panel)
...
async def helper_cb(client, CallbackQuery, _):
    ...
    if cb == "hb1":
        ...
        await CallbackQuery.edit_message_text(
            helpers.HEHP_13, reply_markup=keyboard
        )
